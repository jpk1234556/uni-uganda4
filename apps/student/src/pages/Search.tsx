...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const hostelsSub = supabase
      .channel("student:search:hostels")
      .on(
        "postgres_changes",
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/4 space-y-6">
          <div className="bg-white/5 backdrop-blur-md p-6 rounded-2xl shadow-sm border border-white/10">
            ...
            <Button className="w-full mt-8 bg-gradient-primary text-white hover:opacity-90 shadow-md">
              Apply Filters
            </Button>
          </div>
        </div>
        ...
        <div className="w-full lg:w-3/4">
          <div className="mb-6 flex gap-4">
            ...
            <Button className="h-12 px-8 rounded-full shadow-md bg-gradient-primary hover:opacity-90 text-white">
              Search
            </Button>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-muted-foreground">
              Showing {filteredHostels.length} approved properties
            </p>
          </div>
