...
export default function Home() {
  ...
  const fetchTopHostels = async () => {
    try {
      ...
      if (error) {
        console.warn(
          "Rating order failed, falling back to standard fetch",
          error,
        );
    ...
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        <div className="container mx-auto px-4 max-w-5xl text-center relative z-10">
          ...
          >
            Discover verified hostels near your university in Uganda. Compare
            prices, amenities, and book your home away from home.
          </motion.p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="space-y-1.5 text-left">
                ...
                <div className="relative">
                  ...
                  <select
                    defaultValue=""
                    className="w-full h-14 pl-12 pr-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:ring-2 focus:ring-primary focus:border-transparent outline-none appearance-none transition-all font-semibold text-base"
                  >
                    <option value="" disabled>
                      Choose your university
                    </option>
                    {universities.map((uni) => (
                      <option key={uni} value={uni.toLowerCase()}>
                        {uni}
                      </option>
                    ))}
                  </select>
            ...
            {[
              {
                ...
                sub: "Across all major universities",
              },
              {
                icon: Users,
                count: "5,000+",
                label: "Students Served",
                sub: "Happy students accommodated",
              },
              {
                icon: MapPin,
                count: "8",
                label: "Universities",
                sub: "Covered across Uganda",
              },
              {
                icon: Star,
                count: "4.5",
              ...
              },
              {
                ...
                sub: "All hostels verified",
              },
              {
                icon: Clock,
                count: "24hrs",
                label: "Response Time",
                sub: "Quick booking confirmation",
              },
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <div>
              ...
              <p className="text-slate-600 font-medium text-lg">
                Discover the most popular and highly-rated hostels among
                students
              </p>
            </div>
            <Link to="/search" className="hidden md:flex">
              <Button
                variant="outline"
                className="rounded-full shadow-sm hover:bg-slate-100 font-bold border-slate-300"
              >
                View All
              </Button>
            </Link>
            ...
            {isLoading ? (
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-3 text-center py-20 bg-white rounded-3xl border border-dashed border-slate-300">
                <p className="text-slate-500 font-semibold text-lg">
                  No verified hostels available yet.
                </p>
              </div>
            ) : (
                    ...
                    <div className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-slate-200 flex flex-col h-full">
                      <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                        ...
                        <div className="absolute top-4 left-4 flex gap-2">
                          ...
                          <span className="bg-emerald-500 text-white text-xs font-bold px-3 py-1.5 rounded-lg shadow-sm flex items-center gap-1.5">
                      ...
                      <div className="p-7 flex flex-col flex-1">
                        <div className="flex text-xs text-slate-500 font-bold mb-3 items-center tracking-wide uppercase">
                          ...
                          <span className="truncate">
                            {hostel.address || hostel.university || "Uganda"}
                          </span>
                        </div>
                        <div className="flex justify-between items-start mb-2 gap-3">
                          <h3 className="font-extrabold text-2xl text-slate-900 group-hover:text-primary transition-colors line-clamp-1 flex-1">
                            {hostel.name}
                          </h3>
                        ...
                        <p className="text-sm text-slate-600 font-medium line-clamp-2 mb-5 leading-relaxed">
                          {hostel.description ||
                            "A verified student hostel located conveniently near the university."}
                        </p>
                        ...
                        <div className="flex gap-2 text-xs text-slate-600 font-bold mb-6 flex-wrap">
                          {hostel.amenities?.slice(0, 3).map((amenity, i) => (
                            <span
                              key={i}
                              className="flex items-center gap-1 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-200"
                            >
                              {amenity}
                            </span>
                          ))}
          ...
          <div className="mt-8 text-center md:hidden">
            <Link to="/search">
              <Button
                variant="outline"
                className="rounded-full shadow-sm font-bold border-slate-300 w-full h-12"
              >
                View All Hostels
              </Button>
            </Link>
        ...
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <motion.div {...fadeInUp}>
            ...
            <p className="text-slate-600 max-w-2xl mx-auto mb-20 font-medium text-lg">
              Finding your perfect student hostel in Uganda is now easier than
              ever. Follow these simple steps.
            </p>
          </motion.div>
            ...
            {[
              {
                num: 1,
                title: "Search",
                desc: "Select your university and browse verified hostels nearby.",
                icon: Search,
                color: "bg-amber-500",
              ...
              },
              {
                num: 2,
                title: "Compare",
                desc: "View hostel details, room types, amenities, and verify photos.",
                icon: MapPin,
                color: "bg-primary",
              ...
              },
              {
                num: 3,
                title: "Apply",
                desc: "Submit your booking request online with instant host notifications.",
                icon: CheckCircle2,
                color: "bg-pink-500",
              ...
              },
              {
                num: 4,
                title: "Move In",
                desc: "Once confirmed, process your deposit and move into your new home.",
                icon: HomeIcon,
                color: "bg-purple-500",
              ...
              >
                <div className="w-8 h-8 rounded-full bg-slate-900 text-white flex items-center justify-center font-bold mb-5 shadow-md z-20 transition-transform group-hover:scale-110">
                  {step.num}
                </div>
                <div
                  className={`w-24 h-24 rounded-3xl ${step.color} mb-8 flex items-center justify-center shadow-xl ${step.shadow} transition-transform group-hover:-translate-y-2 group-hover:rotate-3`}
                >
        ...
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          >
            {[
              ...
              {
                name: "Okello James",
                role: "Engineering Student, Kyambogo",
                review:
                  "As a first-year student from Gulu, I was worried about finding accommodation in Kampala. This platform helped me find a great hostel in Banda with all amenities.",
                img: "11",
              },
              {
                name: "Aisha Nambi",
                role: "Business Student, MUBS",
                review:
                  "The booking process was seamless! I applied online and got confirmed instantly. The photos were accurate and the reviews from other students were very helpful.",
                img: "5",
              },
            ].map((testimonial, i) => (
              <motion.div
                variants={itemAnim}
                key={i}
                className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-shadow border border-slate-200 relative group"
              >
                ...
                <p className="text-slate-700 leading-relaxed mb-8 font-semibold italic relative z-10">
                  "{testimonial.review}"
                </p>
