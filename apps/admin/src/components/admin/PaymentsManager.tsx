      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          ...
          <p className="text-slate-500 text-[10px] font-mono mt-1 uppercase tracking-widest">
            TRANSACTION_AUDIT_AND_REVENUE_TRACKING
          </p>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="py-24 flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest">
                Zero_Transactions_Detected
              </h3>
              <p className="text-[10px] text-slate-400 uppercase tracking-wider max-w-xs mt-2 font-mono">
                WAITING_FOR_INBOUND_MOBILE_MONEY_STREAMS
              </p>
            </div>
          ) : (
